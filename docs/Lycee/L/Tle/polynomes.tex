...
\section*{III. Signe d'un polynôme et résolution d'inéquations}

\subsection*{1. Exemple}
Soit \( x^3 - 2x^2 - 5x + 6 \)

\begin{enumerate}
    \item Vérifier que \(-2\) est une racine de \( x^3 - 2x^2 - 5x + 6 \).
    \item Étudier le signe de \( x^3 - 2x^2 - 5x + 6 \).
    \item En déduire les solutions dans \( \mathbb{R} \) de l'inéquation
    \[
    x^3 - 2x^2 - 5x + 6 < 0
    \]
\end{enumerate}

\subsection*{2. Exercice d'application}

\begin{enumerate}
    \item Vérifier que 1 est une racine de \( x^3 - 7x + 6 \).
    \item Étudier le signe de \( x^3 - 7x + 6 \).
    \item En déduire les solutions dans \( \mathbb{R} \) de l'inéquation
    \[
    x^3 - 7x + 6 \geq 0
    \]
...
\section*{IV. Fraction rationnelle}

\subsection*{1. Définition et exemple}

\begin{itemize}
    \item Une \textbf{fraction rationnelle} est un quotient dont le numérateur et le dénominateur sont des polynômes.
    \item L'expression :
    \[
    \frac{x^4 - 8x^2 - 3}{2x^3 + 7x^2 + 7x + 2}
    \]
    est une fraction rationnelle.
\end{itemize}

\subsection*{2. Signe d'une fraction rationnelle}

\paragraph{Exemple :}
\[
\frac{x^3 - 2x^2 - 5x + 6}{x^3 - 7x + 6}
\]
est une fraction rationnelle.

\begin{enumerate}
    \item Montrer que \(-2\) est racine de \( x^3 - 2x^2 - 5x + 6 \) et que 1 est racine de \( x^3 - 7x + 6 \).
    \item Étudier dans un même tableau, les signes de \( x^3 - 2x^2 - 5x + 6 \) et de \( x^3 - 7x + 6 \).
    \item En déduire le signe de
    \[
    \frac{x^3 - 2x^2 - 5x + 6}{x^3 - 7x + 6}
    \]
\end{enumerate}
