...
% ========================================================================
\section*{\color{myred} I) Trinôme Du second Degré}
...
\subsection*{\color{myred} 2) Forme canonique}

\begin{equation*}
\begin{aligned}
p(x) &= ax^2 + bx + c\\
&= a \left[ x^2 + \frac{b}{a}x + \frac{c}{a} \right] \\
&= a \left[ x^2 + \frac{2 \times x \times b}{2 \times a} + \left(\frac{b}{2a}\right)^2 - \left(\frac{b}{2a}\right)^2 + \frac{c}{a} \right] \\
...
\subsection*{Exemple d'application direct avec $\Delta$}

Soit le trinôme $p(x) = 3x^2 - 12x + 5$.

\begin{enumerate}
    \item \textbf{Identification des coefficients :}
    \[
    a = 3, \quad b = -12, \quad c = 5
    \]

    \item \textbf{Calcul du discriminant $\Delta$ :}
    \begin{equation*}
    \begin{aligned}
    \Delta &= b^2 - 4ac \\
    &= (-12)^2 - 4 \times 3 \times 5 \\
    &= 144 - 60 \\
    &= 84
    \end{aligned}
    \end{equation*}
    ...
    En utilisant la formule $p(x) = a \left[ \left(x + \dfrac{b}{2a}\right)^2 - \dfrac{\Delta}{4a^2} \right]$ :

    Calculons d'abord les termes :
    \begin{itemize}
        \item $\dfrac{b}{2a} = \dfrac{-12}{2 \times 3} = \dfrac{-12}{6} = -2$
        \item $\dfrac{\Delta}{4a^2} = \dfrac{84}{4 \times 3^2} = \dfrac{84}{36} = \dfrac{7}{3}$
    \end{itemize}
...
\subsection*{\color{myred} 3) Factorisation de la forme canonique}

Soit un trinôme du $2^{nd}$ degré :
\[
p(x) = ax^2 + bx + c \quad \text{et} \quad \Delta = b^2 - 4ac
\]
et de F.C : $p(x) = a \left[ \left(x + \frac{b}{2a}\right)^2 - \frac{\Delta}{4a^2} \right]$

\begin{itemize}
    \item \textbf{Si $\Delta > 0$ alors :}
    \begin{equation*}
    \begin{aligned}
    p(x) &= a \left[ \left(x + \frac{b}{2a}\right)^2 - \left(\frac{\sqrt{\Delta}}{2a}\right)^2 \right] \\
    &= a \left[ \left(x + \frac{b}{2a} - \frac{\sqrt{\Delta}}{2a}\right) \left(x + \frac{b}{2a} + \frac{\sqrt{\Delta}}{2a}\right) \right]
    \end{aligned}
    \end{equation*}
    ...
    \item \textbf{Si $\Delta < 0$ :} donc le trinôme n'est pas factorisable par la F.C.
\end{itemize}
...
% ========================================================================
\section*{\color{myred} II) ÉQUATIONS DU SECOND DEGRÉ}
...
% ========================================================================
\section*{\color{myred} III) INÉQUATIONS DU SECOND DEGRÉ}
