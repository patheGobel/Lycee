...
\begin{enumerate}
    \item Un polynôme est le produit de plusieurs monômes.
    \item Un trinôme est un polynôme de degré 3.
    \item Un binôme est la somme de deux monômes.
    \item Un monôme est une expression de la forme $ax^n$ ; $a$ est un nombre réel appelé degré et $n$ est le coefficient du monôme.
    \item Un polynôme de degré 2 est une expression sous la forme $cx^2 + ax + b \ ; \ c \neq 0$
\end{enumerate}

\fbox{\textbf{\exo}}

Soit le polynôme P tel que $P(x) = -2x^3 + x^2 + 8x - 4$.

\begin{enumerate}
    \item Calculer $P(2)$ puis conclure.
    \item Montre qu'il existe un polynôme Q tel que $P(x) = (x - 2)Q(x)$ on déterminera le degré de Q.
    \item Détermine $Q(x)$ par la méthode de la division Euclidienne.
...
On donne $P$, un polynôme tel que $P(1) = 0$ et $P(-2) = 0$ et son écriture sous forme de produit de facteurs du premier degré est $P(x) = (x - \dots)(x + \dots)(2x + 3)$.

\begin{enumerate}
    \item Que représentent les réels 1 et $-2$ pour le polynôme $P(x)$ ? 
    \item Quel est le degré du polynôme $P(x)$ ? 
    \item Compléter les pointillés : $P(x) = (x - \dots)(x + \dots)(2x + 3)$ ?
    \item Ecrire le polynôme $P(x)$ sous la forme $P(x) = ax^3 + bx^2 + cx + d$.
\end{enumerate}

\fbox{\textbf{\exo}}

On donne le polynôme : $P(x) = 2x^3 - 9x^2 + 3x + 4$.

\begin{enumerate}
   \item
 		\begin{enumerate}
    	\item Calculer $P(1)$ puis en déduire une factorisation complète de $P(x)$ 
    	\item Résoudre dans $\mathbb{R}$, l'équation : $P(x) = 0$ 
    	\item Résoudre dans $\mathbb{R}$, l'inéquation : $P(x) \geq 0$
    \end{enumerate}
    \item On pose :
    \( H(x) = \frac{P(x)}{2x^2 + 7x + 3} \)
    \begin{enumerate}
        \item Déterminer l'ensemble de définition de $H(x)$.
        \item Simplifier $H(x)$.
    \end{enumerate}
\end{enumerate}
