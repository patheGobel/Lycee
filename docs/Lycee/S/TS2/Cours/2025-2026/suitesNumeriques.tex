...
\subsection*{\underline{\textbf{\textcolor{red}{2.2. Suite définie par récurrence}}}}
\subsection*{\underline{\textbf{\textcolor{red}{ Définition}}}}	
...
\begin{itemize}
	\item \textbf{Croissante} si : $\forall n,\; u_{n+1}\geq u_{n}$,
	
	c'est-à-dire $u_{n+1}-u_{n}\geq 0$.
	
	\item \textbf{Décroissante} si : $\forall n,\; u_{n+1}\leq u_{n}$,
	
	c'est-à-dire $u_{n+1}-u_{n}\leq 0$.
	
	\item \textbf{Constante} si : $\forall n,\; u_{n+1}=u_{n}$.
\end{itemize}

\medskip

\textbf{Étudier le sens de variation d'une suite} $\left(u_{n}\right)$ consiste à déterminer 
si elle est croissante, décroissante ou constante.

\subsection*{\underline{\textbf{\textcolor{red}{3.2 Méthode du quotient (si $u_n>0$)}}}} 
	
	On étudie le signe de $\dfrac{u_{n+1}}{u_n}-1$ ou on compare 
	$\dfrac{u_{n+1}}{u_n}$ à $1$.
	
	\begin{itemize}
		\item Si $\dfrac{u_{n+1}}{u_n} \geq 1$, alors la suite est croissante.
		\item Si $\dfrac{u_{n+1}}{u_n} \leq 1$, alors la suite est décroissante.
	\end{itemize}
	
	Cette méthode est valable uniquement si $u_n>0$.


\subsection*{\underline{\textbf{\textcolor{red}{3.3. Méthode par une fonction associée}}}}  
	
	Si $u_n=f(n)$, on peut étudier les variations de la fonction $f$ 
	sur l'intervalle considéré et en déduire le sens de variation de la suite.

\subsection*{\underline{\textbf{\textcolor{red}{3.4. Méthode par récurrence}}}}   
	
	Dans certains cas, on peut démontrer par récurrence que 
	$u_{n+1} \geq u_n$ ou $u_{n+1} \leq u_n$.

+++++++++++++++++++++++++++++++++++++++++++++

\subsection*{\underline{\textbf{\textcolor{red}{Exercices d'application}}}} 

\textbf{Exercice 1 : Méthode par différence}
...
\textbf{Exercice 2 : Méthode du quotient (suite positive)}
...
\begin{itemize}
	\item Vérifier que $u_n>0$ pour tout $n$.
	\item Étudier le sens de variation de la suite.
\end{itemize}

\bigskip

\textbf{Exercice 3 : Méthode par fonction associée}
...
On considère la fonction $f(x)=\dfrac{1}{x+1}$.
...
\textbf{Exercice 4 : Méthode par récurrence}
...
\begin{itemize}
	\item Montrer que $u_n \geq 0$ pour tout $n$.
	\item Montrer que $u_{n+1} \geq u_n$.
...
\section*{\underline{\textbf{\textcolor{red}{III. Suites Minorée-Majorée-Bornée-Convergente-Divergente}}}}
\begin{comment}
...
\subsection*{\underline{\textcolor{red}{8.Théorème du point fixe}}}

\subsubsection*{\textcolor{red}{a) Définition}}
...
\subsubsection*{\textcolor{red}{b) Théorème}}
...
\subsubsection*{\textcolor{red}{Preuve détaillée}}
...
\subsubsection*{\textcolor{red}{c) Méthode pratique}}
...
\subsubsection*{\textcolor{red}{5) Exemple}}
...
\subsubsection*{\textcolor{red}{Application du théorème du point fixe}}
...
\textbf{\textcolor{red}{1) Montrons que la suite est majorée par 3}}
...
\textbf{\textcolor{red}{2) Étudions la monotonie}}
...
\textbf{\textcolor{red}{3) Conclusion sur la convergence}}
...
\textbf{\textcolor{red}{4) Utilisation du théorème du point fixe}}
