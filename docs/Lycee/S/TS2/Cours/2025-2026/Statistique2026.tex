...
\usepackage{diagbox}     % Séparation diagonale des cases de tableau
...
% ==========================================
% 7. GRAPHISMES, TIKZ, PGFPLOTS ET VARIATIONS
% ==========================================
...
% - fit : enveloppe et ajustement automatique de nœuds

\usepackage{pgfplots}    % Création de graphiques mathématiques et repères
\pgfplotsset{compat=1.18} % Maintient la compatibilité d'affichage pour pgfplots
...
% Filigrane "PGB" centré sur chaque page
\AddToShipoutPicture{
  \AtTextCenter{%
...
% ==========================================
% Chargé impérativement en dernier pour éviter tout conflit de re-définition de macros
\usepackage[colorlinks=true, linkcolor=blue, urlcolor=blue, citecolor=blue]{hyperref}

\begin{document}
% En-tête personnalisée
\begin{center}
    \Large\fcolorbox{green}{white}{\textbf{\textcolor{red}{CHAP 10 : STATISTIQUES}}}\\[-0.1cm]
...
\textbf{Écart-type} : 
\fcolorbox{red}{red!20}{$\sigma(x) = \sqrt{V(x)}$}
