...
% ==========================================
% 4. COULEURS, TEXTE ET ENVIRONNEMENTS TEXTE
% ==========================================
...
% Environnement personnalisé pour les remarques
...
\usepackage{pgfplots}    % Création de graphiques mathématiques et de repères (2D/3D)
\pgfplotsset{compat=1.18} % Fixe la version de compatibilité pour assurer le rendu stable
...
% ==========================================
% Chargé en dernier pour éviter des réécritures de macros conflictuelles
