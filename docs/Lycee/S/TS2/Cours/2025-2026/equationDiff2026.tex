...
\begin{remarque}
Plus généralement, toute combinaison linéaire $\lambda y_1 + \mu y_2$ (où $\lambda, \mu \in \mathbb{R}$) est aussi solution de $(E')$. On dit que l'ensemble des solutions de $(E')$ est un espace vectoriel.
\end{remarque}
