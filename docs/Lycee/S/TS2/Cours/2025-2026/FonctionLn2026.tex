...
\subsubsection*{\underline{\textbf{\textcolor{red}{a. Limites aux bornes de $D_{ln}$}}}}
\begin{itemize}
    \item $\lim_{x \to 0^+} \ln x = -\infty$.
    \item $\lim_{x \to +\infty} \ln x = +\infty$.
\end{itemize}
\subsection*{\underline{\textbf{\textcolor{red}{b. Limites usuelles}}}}
\begin{itemize}
...
\subsection*{\underline{\textbf{\textcolor{red}{c. Limites des composées avec ln}}}}
...
\subsubsection*{\underline{\textbf{\textcolor{red}{d. Croissance comparée de \(\ln x\) et \(x^\alpha\) }}}}
...
\subsection*{\underline{\textbf{\textcolor{red}{2. Dérivée d'une fonction logarithme composée}}}}
