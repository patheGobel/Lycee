...
\section*{Utilisation de l'arbre de choix pondéré}
...
\subsection*{Exemple 1 : Structure générale}
...
\begin{tikzpicture}[level distance=2.5cm,
  ...
  \node {$\Omega$}
    child {node {$A$}
      child {node {$B$} edge from parent node[above left] {$P_A(B)$}}
      child {node {$\bar{B}$} edge from parent node[below left] {$P_A(\bar{B})$}}
      edge from parent node[above] {$P(A)$}
    }
    child {node {$\bar{A}$}
      child {node {$\bar{B}$} edge from parent node[above right] {$P_{\bar{A}}(\bar{B})$}}
      child {node {$B$} edge from parent node[below right] {$P_{\bar{A}}(B)$}}
      edge from parent node[below] {$P(\bar{A})$}
    };
\end{tikzpicture}
\end{center}

\subsection*{Exemple 2 : Compléter l'arbre et calculer $P(B)$}
...
\subsection*{Exemple 3 : Arbre à plusieurs issues}
...
\begin{tikzpicture}[level distance=2.5cm,
  ...
  \node {$\Omega$}
    child {node {$A$}
      child {node {$B$} edge from parent node[above left] {$1/2$}}
      child {node {$C$} edge from parent node[below left] {$1/2$}}
      edge from parent node[above left] {$1/6$}
    }
    child {node {$\bar{A}$}
      child {node {$D$} edge from parent node[above right] {$1/4$}}
      child {node {$B$} edge from parent node[right] {$1/4$}}
      child {node {$C$} edge from parent node[below right] {$2/4$}}
      edge from parent node[below right] {$5/6$}
    };
\end{tikzpicture}
\end{center}
