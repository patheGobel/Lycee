...
\section*{Exercice : Probabilités sur Arbre}

\subsection*{1. Calcul des probabilités totales}
...
\subsection*{2. Calcul des probabilités conditionnelles (Bayes)}
