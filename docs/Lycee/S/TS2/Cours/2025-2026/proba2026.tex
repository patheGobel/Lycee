...
\subsubsection*{1. Analyse de l'univers $\Omega$}
L'ensemble $E$ contient les entiers de 20 à 40.
$\text{Card}(\Omega) = 40 - 20 + 1 = 21$

\subsubsection*{2. Probabilités simples}
...
\begin{itemize}
    ...
    \item \textbf{Événement B :} Multiples de 2 (nombres pairs)
    $B = \{20, 22, 24, 26, 28, 30, 32, 34, 36, 38, 40\} \Rightarrow \text{Card}(B) = 11$
    \[ p(B) = \frac{11}{21} \]

    \item \textbf{Événement C :} Multiples de 6
    $C = \{24, 30, 36\} \Rightarrow \text{Card}(C) = 3$
    \[ p(C) = \frac{3}{21} = \frac{1}{7} \]
\end{itemize}

\subsubsection*{3. Probabilités composées}
