...
% ==========================================
\usepackage[T1]{fontenc}  % Encodage des caractères de sortie (indispensable pour les accents en français)
\usepackage{times}       % Utilise la police Times New Roman pour le texte général
\usepackage{lmodern}     % Complète et améliore le rendu des polices vectorielles
\usepackage{pifont}      % Offre une collection de symboles et puces spéciales (ex: \ding{45})
...
\usepackage{multicol}    % Permet d'écrire du texte sur plusieurs colonnes (\begin{multicols})
\usepackage{fancyhdr}    % Personnalisation avancée des en-têtes et pieds de page
\usepackage{lastpage}    % Donne accès à la référence de la dernière page (\pageref{LastPage})
...
% ==========================================
\usepackage{array}       % Améliore la gestion des colonnes de tableaux
...
% Configuration des styles de puces pour les listes d'énumération (niveaux 1 et 2)
...
% ==========================================
% 9. COMPTEURS ET COMMANDES DU COURS
% ==========================================
\newcounter{exercice}                                   % Création du compteur personnalisé d'exercices
\renewcommand{\theexercice}{\arabic{exercice}}         % Formatage du compteur en chiffres arabes (1, 2, 3...)
\newcommand{\exo}{\refstepcounter{exercice}\textbf{Exercice \theexercice}\ } % Commande \exo pour incrémenter et afficher "Exercice X"

% ==========================================
% 10. HYPERLIENS ET INTERACTIVITÉ
% ==========================================
% Toujours charger hyperref en TOUT DERNIER pour éviter les conflits de redéfinition avec d'autres packages
