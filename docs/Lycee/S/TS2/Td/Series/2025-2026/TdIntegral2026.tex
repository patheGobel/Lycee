...
\begin{tikzpicture}[overlay,remember picture]
    \node[draw=blue,line width=1.2pt,fill=purple,text=blue,inner sep=3mm,rounded corners,pattern=dots]at ([yshift=-2.5cm]current page.north) {\begingroup\setlength{\fboxsep}{0pt}\colorbox{white}{\begin{tabular}{|*1{>{\centering \arraybackslash}p{0.28\textwidth}} |*2{>{\centering \arraybackslash}p{0.2\textwidth}|} *1{>{\centering \arraybackslash}p{0.19\textwidth}|} }
                ...
                \textbf{Matière: Mathématiques}                                                                                    & \textbf{Niveau : T}\textbf{S2} & \textbf{Date: 02/06/2026} & \textbf{} \\ \hline
                \multicolumn{4}{|c|}{\parbox[c]{10cm}{\begin{center}
                                                                  \textbf{{\Large\sffamily Td Intégrale}}
                                                              \end{center}}}                                                                                                        \\ \hline
...
\begin{enumerate}
    ...
    \item Vérifier que : 
\( \forall x \in \mathbb{R} \setminus \left\{-1 ; -\frac{1}{2}\right\} \) \( \frac{8x + 5}{2x^2 + 3x + 1} = \frac{3}{x+1} + \frac{2}{2x+1} \). 
...
\end{enumerate}
\end{enumerate}
\fbox{\textbf{\exo}} : Calculer en utilisant une intégration par parties
\begin{multicols}{2}
\begin{enumerate}
...
\begin{enumerate}
    ...
    \( A = \int_0^1 \frac{e^x}{e^x + 1} \, dx \) et \( B = \int_0^1 \frac{e^x}{(e^x + 1)^2} \, dx \).
...
\[
f(x) = \sqrt{x^2 + 1}, \quad g(x) = x + \sqrt{x^2 + 1}
\]
\[
h(x) = \ln(x + \sqrt{x^2 + 1}) \quad \text{et} \quad k(x) = x \sqrt{x^2 + 1}.
\]
Soit \( \alpha \) un réel, on pose \( \forall n \in \mathbb{N}, I_n = \int_0^\alpha \frac{x^n}{\sqrt{x^2 + 1}} \, dx \) et 
\[
F = \int_0^\alpha \sqrt{x^2 + 1} \, dx, \quad G = \int_0^\alpha (x + \sqrt{x^2 + 1}) \, dx, 
\]
\[
H = \int_0^\alpha \ln(x + \sqrt{x^2 + 1}) \, dx.
\]
\begin{enumerate}
...
\begin{enumerate}
    \item Soit f la fonction définie sur [0; 2] par :
