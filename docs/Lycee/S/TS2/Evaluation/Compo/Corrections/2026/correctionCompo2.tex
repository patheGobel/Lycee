...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item $\lim\limits_{x \to +\infty} f(x) = \lim\limits_{x \to +\infty} 1 + \dfrac{\ln\left(\frac{x}{x+1}\right)}{\frac{x}{x+1}-1}\left(\dfrac{x}{x+1}\right) = 1 + 1 \times 1 = 2$. 
    ...
    \begin{itemize}
        ...
        $\lim\limits_{x \to 0^-} f(x) = \lim\limits_{x \to 0^+} f(x) = f(0)$ donc \colorbox{green}{$f$ est continue en 0.} \hfill \textcolor{red}{0,5pt}
