...
\begin{enumerate}
    ...
    \item Calculer la probabilité que le serveur soit actif pendant exactement 8 jours (arrondir à $10^{-3}$).\hfill \textbf{(0,5 pt)}
    \item Calculer la probabilité que le serveur subisse au moins une maintenance durant ces 10 jours (arrondir à $10^{-3}$).\hfill \textbf{(0,5 pt)}
\end{enumerate}
...
\begin{enumerate}
    ...
    Montrer que : $\Sigma_N = \dfrac{280\,000}{13} \times \left[1 - (-0,3)^N\right] + \dfrac{37\,000}{13}N$.\hfill \textbf{(1 pt)}
\end{enumerate}
