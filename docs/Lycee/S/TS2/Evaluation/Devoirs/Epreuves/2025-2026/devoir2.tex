...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item Donner la nature de l'asymptote en $+\infty$. \hfill $(0,5pt)$
    \end{enumerate}
    \item 
    \begin{enumerate}
    ...
    \end{enumerate}
    \item Démontrer que : $ f(\alpha) = -2+\dfrac{3(\alpha-2)}{\alpha^2 - 1} $. \hfill $(0,5pt)$
    \item 
    \begin{enumerate}
        \item Montrer que $\forall x \in ]-\infty; -1[ \cup ]-1; 0[$, on a : 
        $f'(x) = \dfrac{-xg(x)}{(x^2-1)^2}$  puis étudier son signe.\hfill $(1pt)$
...
\begin{enumerate}
    ...
    \item Calculer $h(1)$ et $(h^{-1})'(\sqrt{2}+1)$. \hfill $(0,5pt)$
