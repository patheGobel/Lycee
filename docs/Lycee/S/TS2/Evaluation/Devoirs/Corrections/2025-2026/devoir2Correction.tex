...
\end{itemize}
   ...
   \end{resultbox}         
    ...
    \item 
    \begin{enumerate}
        \item Montrons que $f$ est continue sur $D_f$. \hfill $(0,75pt)$
...
\end{itemize}       
        ...
        \item Étudions la dérivabilité de $f$ en $0$ puis interprétons le résultat obtenu. \hfill $(01pt)$
...
\end{comment}      
    ...
    \end{enumerate}
    \item Démontrons que : $ f(x) = -2+\dfrac{3(\alpha-2)}{\alpha^2 - 1} $. \hfill $(0,5pt)$
 ...
 \)      
    ...
    \begin{enumerate}
        ...
        $f'(x) = \dfrac{-xg(x)}{(x^2-1)^2}$ puis étudier son signe \hfill $(0,5pt)$
\begin{itemize}
\item Montrons que $\forall x \in ]-\infty; -1[ \cup ]-1; 0[$, on a : 
...
\item le signe de $f'(x)$ dépend du numérateur     
...
\end{itemize}  
        \item Calculons $f'(x)$ sur $]0; +\infty[$ et étudions son signe.
			...
			\begin{itemize}
			\item Calculons $f'(x)$ sur $]0; +\infty[$
			
\(
\begin{aligned}
f'(x) &= 1 + \dfrac{2x+1}{2\sqrt{x^2+x}}\\
      &= \dfrac{2\sqrt{x^2+x}+2x+1}{2\sqrt{x^2+x}}\\
      &= \dfrac{2\sqrt{x^2+x}+2x+1}{2\sqrt{x^2+x}} \textbf{(0,5pt)}\\
\end{aligned}
\)

			\item étudions son signe
...
\textcolor{red}{Ainsi  $\forall x\in ]0;+\infty[$ $f'(x) > 0 $ donc f  est croissant $]0;+\infty[$}	 \textbf{(0,5pt)}	
			
			\end{itemize}			        
        
        \item Dressons le tableau de variation de $f$ sur $D_f$. \hfill $(0,75pt)$
...
\end{tikzpicture}          
    ...
    \end{enumerate}
    \item Construisons soigneusement la courbe $(C_f)$. \hfill $(01pt)$
\end{enumerate}
...
\begin{enumerate}
    \item Montrons que $h$ réalise une bijection de $I$ vers un intervalle $J$ à préciser. \hfill $(0,5pt)$
...
Sur $I$ $h$ est continue est strictement croissante donc réalise une bijection de $I$ vers $J=[0,+\infty[$
    ...
    \item Calculons $h^{-1}(1)$ et $(h^{-1})'(\sqrt{2}+1)$. \hfill $(0,5pt)$
...
\end{itemize}   
    ...
    \item Explicitons $h^{-1}(x)$. \hfill $(0,5pt)$
...
\end{resultbox}    
    ...
    \item Construisons $(C_{h^{-1}})$ dans le repère précédent. \hfill $(0,5pt)$ 
