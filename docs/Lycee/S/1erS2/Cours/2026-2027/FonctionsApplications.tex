...
\section*{\underline{\textbf{Applications}}}
...
\paragraph{\color{darkred}c) Bijections réciproques :}~\\

\subsubsection*{\underline{\textbf{\textcolor{darkred}{Définition :}}}}
...
\subsubsection*{\underline{\textbf{Propriété :}}}

Si $f^{-1}$ est l'application de $f$, alors $f$ est aussi l'application
réciproque de $f^{-1}$.

\subsubsection*{\textbf{\textcolor{darkred}{Ex :}}}
...
\subsubsection*{\underline{\textbf{\textcolor{darkred}{Résolution :}}}}
