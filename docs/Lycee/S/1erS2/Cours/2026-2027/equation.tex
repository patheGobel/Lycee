...
\begin{center}
    \Large\textbf{\underline{\textcolor{red}{Equations-Inéquations-Systèmes}}}\\[-0.1cm]
...
\subsection*{\underline{\textbf{\textcolor{red}{1. Compléments sur les polynômes}}}}
\subsubsection*{\underline{\textbf{\textcolor{red}{a. Trinôme du second degré}}}}
\begin{itemize}
...
Si $\Delta \geq 0$, alors : $S = x_1 + x_2 = -\dfrac{b}{a}$ et $P = x_1 x_2 = \dfrac{c}{a}$

\item \textcolor{red}{\underline{Théorème réciproque}}

Une somme $S$ et un produit $P$ de deux réels $x$ et $y$ sont liés par l’équation suivante :

\( \boxed{x^2 - Sx + P = 0} \)

Autrement dit, si : \( x + y = S
\quad \text{et} \quad
xy = P, \)

alors $x$ et $y$ sont les solutions de l’équation : \( x^2 - Sx + P = 0. \)
...
\subsubsection*{\underline{\textbf{\textcolor{red}{b. Équation bicarrée et équation symétrique}}}}
\begin{itemize}
...
$$ \boxed{ S=\left\lbrace-1;\ -\dfrac{\sqrt{3}}{3};\ \dfrac{\sqrt{3}}{3};\ 1\right\rbrace } $$
...
Pour résoudre une telle équation, on factorise par $x^{2}$ et on fait un changement de variable de la forme $X=x+\dfrac{1}{x}.$
...
\begin{enumerate}
\item Montrer que 0 n'est pas solution de $f(x)=0$
\item Déterminer $g(x)$ telle que $f(x)=x^{2}.g(x)$
\item Montrer que $f(x)=0$ si, et seulement si, $g(x)=0$
\item Résoudre dans $\mathbb{R}\ \ g(x)=0$. On pose $X=x+\dfrac{1}{x}$
\end{enumerate}

\textbf{\solution}

\begin{enumerate}
\item Montrons que 0 n'est pas solution de $f(x)=0$

On a $f(0)=6\neq 0$ donc 0 n'est pas solution de $f(x)=0$

\item Déterminons $g(x)$ pour que $f(x)=x^{2}.g(x)$

Nous avons :

$
\begin{aligned}
f(x) &= 6x^{4}-5x^{3}-38x^{2}-5x+6 \\ 
...
\item Montrons que $f(x)=0$ si, et seulement si, $g(x)=0$
...
\item Résolvons dans $\mathbb{R}\ \ g(x)=0$.
...
$
\begin{aligned} 
g(x) &=6x^{2}-5x-38-\dfrac{5}{x}+\dfrac{6}{x^{2}} \\ 
&=6\left(x^{2}+\dfrac{1}{x^{2}}\right)-5\left(x+\dfrac{1}{x}\right)-38 \\ 
&=6(X^{2}-2)-5X-38 \\ 
&=6X^{2}-12-5X-38 \\ 
&=6X^{2}-5X-50 
\end{aligned}
...
$$ \boxed{ S=\left\lbrace-2\;;\ -\dfrac{1}{2}\;;\ \dfrac{1}{3}\;;\ 3\right\rbrace } $$

\end{enumerate}

\end{itemize}
\subsubsection*{\underline{\textbf{\textcolor{red}{c. Équation paramétrique }}}}
\textbf{\exemple}

Soit l'équation $(E) : x^2 - (2m + 1)x + m^2 - 2 = 0$

\begin{enumerate}
    \item Discuter suivant les valeurs de $m$, les solutions de l'équation $(E)$
    
    \item Trouver une relation indépendante de $m$ entre $x'$ et $x''$
    
    \item Déterminer $m$ pour que $(E)$ admette :
    \begin{enumerate}
        \item Deux solutions de signes contraires.
        \item Deux solutions positives.
        \item Deux solutions négatives.
    \end{enumerate}
\end{enumerate}
\textbf{\solution}
