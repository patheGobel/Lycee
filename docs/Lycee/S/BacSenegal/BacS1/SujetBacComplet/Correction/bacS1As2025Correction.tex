...
<<<<<<< HEAD
		 ...
		 \item Prouver alors que \( R_{1} \circ R_{2} =  R_{2} \circ R_{1} \)\hfill \textbf{(0,5 point)}
		 
		 On peut aussi écrire : \( R_{1} = S_{p_{1}} \circ S_{p} \). On a alors :
		 
		 \( R_{1} \circ R_{2} = (S_{p_{1}} \circ S_{p})(S_{p} \circ S_{p_{2}}) = S_{p_{1}} \circ S_{p_{2}} \)
		 
		 Or, \( S_{p_{1}} \circ S_{p_{2}} \) est aussi est la rotation d’axe \( (P_{1})\cap (P_{2}) = \Delta \) 
		 
		 et d'angle 2$\times $ [ l’angle formé par $(P_{1})$ et $(P_{2})$] = $2\times\frac{\pi}{2} = \pi $
		 	
		 C’est donc le demi-tour d’axe $\Delta$\hfill \textbf{(0,5 point)}
		 
		 Finalement, \( R_{1} \circ R_{2} = R_{2} \circ R_{1} \)
=======
