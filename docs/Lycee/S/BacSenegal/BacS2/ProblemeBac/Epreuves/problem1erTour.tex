...
\begin{tikzpicture}[overlay,remember picture]
    \node[draw=blue,line width=1.2pt,fill=purple,text=blue,inner sep=3mm,rounded corners,pattern=dots]at ([yshift=-2.5cm]current page.north) {\begingroup\setlength{\fboxsep}{0pt}\colorbox{white}{\begin{tabular}{|*1{>{\centering \arraybackslash}p{0.28\textwidth}} |*2{>{\centering \arraybackslash}p{0.2\textwidth}|} *1{>{\centering \arraybackslash}p{0.19\textwidth}|} }
                ...
                \multicolumn{4}{|c|}{\parbox[c]{10cm}{\begin{center}
                  \textbf{{\Large\sffamily Problèmes proposés au BAC S2 Sénégal depuis 1999 }}
                \end{center}}} \\ \hline
...
\( y=-x+4 \) est une asymptote oblique à $(C_f)$ au voisinage de $-\infty$.
...
\item Calculer $f'(x)$ pour \( x\in]-\infty;2[ \) et pour \( x\in]2;+\infty[ \) puis montrer que pour tout
  ...
  \( x\in]2;+\infty[ \),  \( f'(x)=\dfrac{g(x)}{h(x)} \).
...
f(x)=
\begin{cases}
x+1+\dfrac{3e^x}{e^x+2} & \text{si } x\leq 0 \\[0.4cm]
x+2+\dfrac{\ln(x+1)}{x+1} & \text{si } x>0
\end{cases}
\)

et $(C_f)$ sa courbe représentative dans un repère orthonormé $(O;\vec{i},\vec{j})$ d’unité graphique 1 cm.

\begin{enumerate}
\item Établir que $f$ est définie sur $\mathbb{R}$.

\item 
\begin{enumerate}
\item Étudier la continuité de $f$ en $0$.
\item Pour tout $x<0$, montrer que  

\( \dfrac{f(x)-f(0)}{x-0}
=1+\dfrac{2(e^x-1)}{x}\times\dfrac{1}{e^x+2}. \)  
...
\item 
\begin{enumerate}
\item En utilisant les variations de la fonction $h$ définie par \( h(x)=\ln x - x \), montrer que \( \ln(x)<x \) pour $x>0$.  
En déduire que \( \ln(x+1)<(x+1)^2 \) pour $x>0$.
...
\item Calculer \( \lim_{x\to -\infty}[f(x)-(x+1)] \) et interpréter le résultat.
\item Calculer \( \lim_{x\to +\infty}[f(x)-(x+2)] \) et interpréter le résultat.
\item Étudier le signe de $f(x)-(x+1)$ pour $x<0$, montrer que $f(x)-(x+2)>0$ pour $x>0$ et interpréter graphiquement les résultats.
\end{enumerate}

\item Déterminer les coordonnées du point $A$ de la courbe où la tangente est parallèle à l’asymptote pour $x>0$.

\item Établir que $f$ est une bijection de $\mathbb{R}$ sur un intervalle $J$ à préciser.

\item Représenter graphiquement les courbes de $f$ et $f^{-1}$ dans un même repère.

\item Calculer  
\( \displaystyle \int_{-\ln 3}^{0} \big(f(x)-(x+1)\big)\,dx. \)

\item Interpréter le résultat précédent en terme d’aire.
\end{enumerate}
...
f(x)=
\begin{cases}
e^x-x & \text{si } x<0 \\[0.3cm]
\dfrac{x^2+x+1}{-x^2+x-1} & \text{si } x\geq 0
\end{cases}
\)
...
\begin{enumerate}
\item Calculer les limites de $f$ aux bornes de son ensemble de définition.
\item Calculer \( \lim_{x\to -\infty}[f(x)+x]. \)
\item Interpréter graphiquement les résultats de calcul de limites.
\end{enumerate}

\item 
\begin{enumerate}
\item Étudier la continuité de $f$ en $0$ puis sur son ensemble de définition.
\item Étudier la dérivabilité de $f$ en $0$ puis interpréter graphiquement les résultats obtenus.
\end{enumerate}

\item Calculer $f'(x)$ et déterminer son signe sur les intervalles sur lesquels $f$ est dérivable.

\item Dresser le tableau de variations de $f$.

\item Soit $h$ la restriction de $f$ à $]-\infty;0[$.  
Montrer que $h$ réalise une bijection sur $]-\infty;0[$ vers un intervalle $J$ que l’on précisera.

\item Représenter la courbe $(C_f)$ de $f$ et la courbe $(C_{h^{-1}})$ de $h^{-1}$ réciproque de $h$, dans le même repère.
\end{enumerate}
...
\item Le plan est muni d’un repère orthonormé $(O;\vec{i},\vec{j})$ d’unité graphique 1 cm.  
On considère la fonction $f$ de représentation graphique $(C_f)$ définie par :

\(
f(x)=
\begin{cases}
e^{-x}[\,1+\ln(1+x)\,] & \text{si } x\geq 0 \\[0.4cm]
x+\dfrac{2x^2}{e^x+1} & \text{si } x<0
\end{cases}
\)

\begin{enumerate}
\item Montrer que l’ensemble de définition $D_f$ de $f$ est $\mathbb{R}$.
\item Étudier les limites aux bornes de $D_f$.
\item Montrer que $f$ est continue en $0$.
\item Démontrer que pour tout $x\in]0;+\infty[$,
\( \dfrac{f(x)-f(0)}{x-0}
=\dfrac{1}{e^x}\left[\dfrac{\ln(x+1)}{x}-\dfrac{e^x-1}{x}\right]. \)
\item Étudier la dérivabilité de $f$ en $0$ et interpréter géométriquement les résultats obtenus.
\item Calculer $f'(x)$ sur chacun des intervalles où $f$ est dérivable.
\end{enumerate}

\item Étudier le sens de variations de $f$ puis dresser son tableau de variations.

\item Montrer que l’équation $f(x)=0$ admet une unique solution $\alpha\in]-\infty;0[$ et vérifier que  

\( -0,7<\alpha<-0,6. \)

\item Montrer que la droite $(\Delta)$ d’équation \( y=x \) est une asymptote oblique à $(C_f)$ en $-\infty$ et donner l’autre asymptote à $(C_f)$.

\item Préciser la position relative de $(\Delta)$ par rapport à $(C_f)$.

\item Tracer $(C_f)$ et ses asymptotes.
\end{enumerate}

\textbf{Partie B :}

Soit $\lambda\in]-\infty;0[$ tel que $\lambda<\alpha$, $\alpha$ étant le réel défini dans la partie A.

Soit la partie du plan comprise entre $(C_f)$, $(\Delta)$, les droites d’équations $x=\lambda$ et $x=\alpha$ et $A(\lambda)$ son aire exprimée avec l’unité d’aire.

\begin{enumerate}
\item Calculer $A(\lambda)$ en fonction de $\lambda$ et $\alpha$.
\item En déduire \( \lim_{\lambda\to -\infty} A(\lambda). \)
\end{enumerate}
...
f(x)=
\begin{cases}
x+(1-x)e^{2x} & \text{si } x\in]-\infty;0[ \\[0.3cm]
xe^{-x} & \text{si } x\in[0;+\infty[
\end{cases}
\)

et on désigne par $(C_f)$ sa courbe représentative dans un repère orthonormé $(O;\vec{i},\vec{j})$, d’unité graphique 2 cm.
...
\begin{enumerate}
\item Étudier les limites de $f$ en $-\infty$ et en $+\infty$.
\item Interpréter graphiquement, si possible, les résultats obtenus.
\item Montrer que la droite $(\Delta)$ d’équation \( y=x \) est une asymptote oblique pour $(C_f)$ au voisinage de $-\infty$.
\end{enumerate}

\item Étudier la continuité de $f$ en $0$.

\item Soit $h$ la fonction définie sur $]-\infty;0[$ par  

\( h(x)=1+(1-2x)e^{2x}. \)

\begin{enumerate}
\item Dresser le tableau de variations de $h$ sur $]-\infty;0[$.
\item En déduire son signe sur $]-\infty;0[$.
\end{enumerate}

\item 
\begin{enumerate}
\item Étudier la dérivabilité de $f$ en $0$.
\item Calculer $f'(x)$ dans chaque intervalle où $f$ est dérivable.
\item Dresser le tableau de variations de $f$ sur $\mathbb{R}$.
\end{enumerate}

\item Tracer la courbe $(C_f)$ dans le repère $(O;\vec{i},\vec{j})$.  
(On précisera les demi-tangentes à $(C_f)$ au point $O$.)
\end{enumerate}
...
\begin{enumerate}
\item Calculer en cm$^2$, l’aire $S(\alpha)$ de la partie du plan formée par l’ensemble des points $M(x;y)$ tels que  
\( 0\leq x\leq \alpha \) et \( 0\leq y\leq f(x). \)

\item Déterminer la limite de $S(\alpha)$ quand $\alpha$ tend vers $+\infty$.
\end{enumerate}

\exo

\textbf{A.} Soit la fonction $f$ définie par :

\(
f(x)=
\begin{cases}
1+x-x\ln x & \text{si } 0<x<1 \\[0.3cm]
1+\dfrac{1}{\sqrt{x}} & \text{si } x\geq 1
\end{cases}
\)
...
\item Étudier la dérivabilité de $f$ en $1$ et interpréter graphiquement les résultats obtenus.

\item Déterminer les limites de $f$ aux bornes de $D_f$ et interpréter graphiquement, si possible, les résultats obtenus.

\item Montrer que $f$ admet un prolongement par continuité à droite en $0$ et définir ce prolongement $h$.

\item Calculer $f'(x)$ dans chacun des intervalles $]0;1[$ et $]1;+\infty[$.  
Dresser le tableau de variations de $f$.

\item 
\begin{enumerate}
\item Tracer $(C_f)$.
\item Calculer l’aire $A$ en cm$^2$ de la partie du plan comprise entre $(C_f)$, la droite d’équation $y=1$, la droite d’équation $x=1$ et la droite d’équation $x=4$.
\end{enumerate}
\end{enumerate}
...
\( g(x)=1+\dfrac{1}{\sqrt{x}}. \)

\begin{enumerate}
\item Étudier les variations de $g$.
\item Montrer que l’équation $g(x)=x$ admet une unique solution $\alpha$ et que  
\( 1<\alpha<2. \)  
En déduire un encadrement de $\alpha$ à $10^{-1}$ près.
\item Montrer que : \( \forall x\in[1;+\infty[, \ |g'(x)|\leq \dfrac{1}{2}. \)
\item En déduire que : 
 
\( \forall x\in[1;+\infty[, \ |g(x)-\alpha|\leq \dfrac{1}{2}|x-\alpha|. \)
\end{enumerate}

\item Soit $(W_n)$ la suite définie par :

\(
\begin{cases}
W_0=2 \\
W_{n+1}=1+\dfrac{1}{\sqrt{W_n}}, \quad n\in\mathbb{N}
\end{cases}
\)
...
\begin{enumerate}
\item $W_n\geq 1$,
\item $|W_{n+1}-\alpha|\leq \dfrac{1}{2}|W_n-\alpha|$,
\item $|W_n-\alpha|\leq \left(\dfrac{1}{2}\right)^n |W_0-\alpha|$.  

En déduire \( \displaystyle \lim_{n\to+\infty} W_n. \)
\end{enumerate}
\end{enumerate}
...
f(x)=
\begin{cases}
2x+(1-x)e^x & \text{si } x\in]-\infty;0[ \\[0.3cm]
xe^{-2x} & \text{si } x\in[0;+\infty[
\end{cases}
\)
...
\item Étudier les limites de $f$ en $-\infty$ et en $+\infty$.
\item Interpréter graphiquement, si possible, les résultats obtenus.
\item Montrer que la droite $(\Delta)$ d’équation \( y=2x \) est une asymptote oblique à $(C_f)$ au voisinage de $-\infty$.
\end{enumerate}
...
\item Tracer $(C_f)$ dans le repère $(O;\vec{i},\vec{j})$.  
(On précisera les demi-tangentes à $(C_f)$ en $0$.)
\end{enumerate}

\textbf{II)}

Soit $\alpha$ un réel strictement positif $(\alpha>0)$.
...
\item Soit $h$ une fonction définie sur $\mathbb{R}$ par

\( h(x)=ax\,e^{-2x}+b \) où $a$ et $b$ sont des réels.
...
\item Déterminer la solution $k$ de $(E)$ dont la courbe représentative $(C_k)$ dans un repère orthonormal $(O;\vec{i},\vec{j})$ passe par le point $O$.
\end{enumerate}
...
f(x)=
\begin{cases}
(6x-2)e^{-2x}+2 & \text{si } x\le 0,\\[0.3cm]
\dfrac{x+\ln|1-x|}{1-x} & \text{si } x>0.
\end{cases}
\)

et $(C_f)$ sa courbe représentative dans un repère orthonormé d’unité graphique \(2\,\text{cm}\).

\begin{enumerate}
\item Justifier que l’ensemble de définition $D_f$ de $f$ est \( \mathbb{R}\setminus\{1\} \).

\item Étudier les limites aux bornes de $D_f$ et interpréter graphiquement, si possible, les résultats obtenus.

\item Déterminer \( \lim_{x\to-\infty} f(x) \) et interpréter graphiquement le résultat.
...
\item Montrer sur l’intervalle \( ]1,2[ \) que l’équation \( f(x)=0 \) admet une unique solution $\alpha$ et que
\( 1{,}2<\alpha<1{,}3 \).

\item Construire $(C_f)$ et ses asymptotes.

\item Calculer en cm$^2$ l’aire $A(E)$ de la partie $E$ du plan comprise entre les droites d’équations
\( x=2 \), \( x=3 \), \( y=-1 \) et la courbe $(C_f)$ de $f$.
\end{enumerate}
...
\item Calculer $g'(x)$ puis étudier son signe.
\item Dresser le tableau de variations de $g$.
\item Calculer $g(0)$ et en déduire le signe de $g$.
\end{enumerate}
...
f(x)=
\begin{cases}
x(e^x-1) & \text{si } x\leq 0 \\
\dfrac{x}{\ln x} & \text{si } x>0
\end{cases}
\)
...
\begin{enumerate}
\item Démontrer que l’ensemble de définition $D_f$ de $f$ est $\mathbb{R}\setminus\{1\}$.
\item Étudier la continuité de $f$ en $0$.
\item Étudier la dérivabilité de $f$ en $0$ et interpréter géométriquement le résultat obtenu.
\item Étudier les limites de $f$ aux bornes de $D_f$ et interpréter graphiquement, si possible, les résultats obtenus.
\item Préciser la nature des branches infinies de $(C_f)$.
\item 
\begin{enumerate}
\item Calculer $f'(x)$ sur $]-\infty,0[$ et sur $]0,+\infty[\setminus\{1\}$.
\item Étudier le signe de $f'(x)$ sur $D_f$.
\end{enumerate}
\item Dresser le tableau de variations de $f$.
\item Construire $(C_f)$ et ses asymptotes.
\item Soit $\alpha$ un réel strictement négatif.
\begin{enumerate}
\item Déterminer l’aire $A(\alpha)$ exprimée avec l’unité d’aire de la partie du plan comprise entre la courbe $(C_f)$, la droite d’équation \( y=-x \), l’axe des ordonnées et la droite d’équation \( x=\alpha \).
\item En déduire \( \displaystyle \lim_{\alpha\to-\infty} A(\alpha) \).
\end{enumerate}
\end{enumerate}
...
\item En déduire le signe de \( v(x) \) pour \( x>0 \).
\end{enumerate}
...
f(x)=
\begin{cases}
xe^x-x-1 & \text{si } x\le 0 \\
x^2-1-2x\ln x & \text{si } x>0
\end{cases}
\)

et \( (C_f) \) sa courbe représentative dans un repère orthonormé \( (O;\vec{i},\vec{j}) \) d’unité \( 1\,\text{cm} \).
...
\item Montrer que l’ensemble de définition de \( f \) est \( \mathbb{R} \).
\item Étudier les limites de \( f \) en \( -\infty \) et en \( +\infty \).
\item Montrer que la droite \( (D) \) d’équation 

\( y=-x-1 \) est asymptote à \( (C_f) \) en \( -\infty \).

Préciser la position de \( (C_f) \) par rapport à \( (D) \) sur \( ]-\infty,0[ \).

\item Étudier la nature de la branche infinie de \( (C_f) \) en \( +\infty \).
\end{enumerate}
...
\item Montrer que pour tout \( x>0 \), \( f'(x)=2v(x) \).
...
\item Tracer \( (D) \) et \( (C_f) \) dans le plan muni du repère \( (O;\vec{i},\vec{j}) \).

\item
\begin{enumerate}
\item Soit \( g \) la restriction de \( f \) à l’intervalle \( ]0,+\infty[ \).

Montrer que \( g \) admet une bijection réciproque \( g^{-1} \) dont on précisera l’ensemble de définition et le sens de variations.

\item Tracer la courbe représentative \( (C_{g^{-1}}) \) de \( g^{-1} \) dans le plan muni du repère \( (O;\vec{i},\vec{j}) \).
\end{enumerate}

\item Soit \( \lambda \) un réel strictement négatif.

\begin{enumerate}
\item Exprimer l’aire \( A(\lambda) \) en fonction de \( \lambda \) de la partie du plan délimitée par les droites d’équations \( x=\lambda \), \( x=0 \), \( y=-x-1 \) et la courbe \( (C_f) \).
\item En déduire \( \displaystyle \lim_{\lambda\to -\infty} A(\lambda) \).
\end{enumerate}
...
\begin{enumerate}
\item Étudier les limites de $g$ en $0^+$ et en $+\infty$.
\item Calculer $g'(x)$ sur $]0,+\infty[$ et étudier son signe.
\item Dresser le tableau de variations de $g$.
\item Montrer que $g$ admet un extrémum sur $]0,+\infty[$.

En déduire que : \( \forall x\in]0,+\infty[, \ g(x)\neq 0. \)
\end{enumerate}
...
f(x)=
\begin{cases}
\dfrac{x}{x-\ln x}+1 & \text{si } x>0,\\[0.3cm]
(x+1)^2e^{-x} & \text{si } x\le 0.
\end{cases}
\)

et $(C_f)$ sa courbe dans un repère orthonormé $(O;\vec{i},\vec{j})$ d’unité graphique \(2\,\text{cm}\).

\begin{enumerate}
\item Montrer que l’ensemble de définition $D_f$ de $f$ est $\mathbb{R}$.

\item Étudier les limites de $f$ aux bornes de $D_f$ et en déduire les asymptotes éventuelles à $(C_f)$.

\item Déterminer \( \displaystyle \lim_{x\to-\infty}\frac{f(x)}{x} \) et interpréter graphiquement le résultat obtenu.
...
\item 
\begin{enumerate}
\item Calculer $f'(x)$ sur $]-\infty,0[$ et sur $]0,+\infty[$.
\item Étudier le signe de $f'(x)$ et dresser le tableau de variations de $f$.
\end{enumerate}

\item Construire $(C_f)$.

\item On pose \( F(x)=(ax^2+bx+c)e^{-x} \) où $a$, $b$ et $c$ sont des réels.
\begin{enumerate}
\item Déterminer $a$, $b$ et $c$ pour que $F$ soit une primitive de $f$ sur $]-\infty,0]$.
\item Calculer en cm$^2$ l’aire \( A(E) \) de la partie $E$ du plan comprise entre l’axe des abscisses, $(C_f)$ et les droites d’équations \( x=-1 \) et \( x=0 \).
\end{enumerate}
...
Soit $g$ la fonction définie sur $[1;+\infty[$ par :

\( g(x)=1-x\ln x. \)

\begin{enumerate}
\item Montrer que \( \forall x\in[1;+\infty[, \ g'(x)<0. \)  \textbf{(0,25 point)}

\item Dresser le tableau de variations de $g$. \textbf{(0,5 point)}
...
f(x)=
\begin{cases}
(-x+1)\ln(-x+1) & \text{si } x<1 \\[0.3cm]
e^{-x+1}\ln x & \text{si } x\geq 1
\end{cases}
\)

$(C_f)$ sa courbe représentative dans le plan muni d’un repère orthonormé $(O;\vec{i},\vec{j})$ d’unité 2 cm.

\begin{enumerate}
\item 
\begin{enumerate}
\item Montrer que $f$ est définie sur $\mathbb{R}$. \hfill (0,5 point)

\item Rappeler les limites suivantes :
\( \lim_{x\to +\infty}\dfrac{\ln x}{x}, \quad
\lim_{x\to 1}\dfrac{\ln x}{x-1}, \quad
\lim_{x\to +\infty}\ln x, \quad
\lim_{x\to -\infty} xe^x. \)
\hfill (01 point)

\item Déterminer \( \lim_{x\to -\infty} f(x), \quad
\lim_{x\to +\infty} f(x) \)
et interpréter graphiquement, si possible, les résultats obtenus.
\hfill (0,75 point)

\item Étudier la branche infinie de la courbe $(C_f)$ de $f$ en $-\infty$.
\hfill (0,25 point)
\end{enumerate}

\item 
\begin{enumerate}
\item Montrer que $f$ est continue en $1$. \hfill (0,5 point)

\item Étudier la dérivabilité de $f$ en $1$ et interpréter géométriquement, si possible, les résultats obtenus.
\hfill (0,5 point)
\end{enumerate}

\item 
\begin{enumerate}
\item Calculer $f'(x)$ sur $]-\infty;1[$ et étudier son signe.
\hfill (0,5 point)

\item Montrer que :

 \( \forall x\in]1;+\infty[, \ f'(x)=\dfrac{g(x)e^{-x+1}}{x}. \)
\hfill (0,25 point)

En déduire le signe de $f'(x)$ sur $]1;+\infty[$.
\hfill (0,25 point)
\end{enumerate}

\item Dresser le tableau de variations de $f$. \hfill (0,5 point)

\item Tracer la courbe représentative $(C_f)$ de $f$ dans le plan muni du repère $(O;\vec{i},\vec{j})$.
\hfill (0,75 point)
\end{enumerate}
...
\begin{enumerate}
\item Montrer que $h$ admet une fonction réciproque $h^{-1}$. \hfill (0,25 point)

\item Préciser l’ensemble de définition de $h^{-1}$ et tracer sa courbe dans le plan muni du repère $(O;\vec{i},\vec{j})$.
\hfill (0,25 point)
\end{enumerate}

\item Calculer en cm $^2$ l’aire $A(\xi)$ de la partie $\xi$ du plan comprise entre l’axe des abscisses, la droite d’équation $x=-1$, l’axe des ordonnées et la courbe $(C_f)$ de $f$.
\hfill (0,25 point)
\end{enumerate}

\exo

Le plan est muni d’un repère orthonormé $(O;\vec{i},\vec{j})$ d’unité 2 cm.
...
\item Détermine la solution particulière de (E) dont la courbe représentative passe par le point $A(0,3)$ et admet en ce point une tangente parallèle à l’axe des abscisses.
\end{enumerate}
...
f(x)=
\begin{cases}
\sqrt{x+2}\ln(x+1) & \text{si } x>0 \\[0.3cm]
e^{2x}+2e^{-x}-3 & \text{si } x\leq 0
\end{cases}
\)
...
\item Montre que $f$ est continue sur $\mathbb{R}$.
\item Détermine les limites de $f$ en $-\infty$ et en $+\infty$.
\item Étudie la nature des branches infinies de $(C_f)$.
\item Étudie la dérivabilité de $f$ en $0$ et interprète géométriquement les résultats.
\item Calcule $f'(x)$ sur chacun des intervalles $]-\infty,0[$ et $]0,+\infty[$ et étudie son signe.
\item Dresse le tableau de variations de $f$.
\item Construis la courbe $(C_f)$.
\end{enumerate}

\textbf{Partie C}

\begin{enumerate}
\item Soit $g$ la restriction de $f$ à l’intervalle $]-\infty,0]$.
\begin{enumerate}
\item Montre que $g$ admet une fonction réciproque $g^{-1}$ dont on précisera l’ensemble de définition.
\item Construis la courbe $(C_{g^{-1}})$ de $g^{-1}$ dans le même repère $(O;\vec{i},\vec{j})$.
\end{enumerate}

\item
\begin{enumerate}
\item Calcule en cm$^2$ l’aire $A(P)$ de la partie $P$ du plan comprise entre la courbe $(C_f)$, l’axe des abscisses, les droites d’équations $x=-1$ et $x=0$.
\item Pour $-1\leq x\leq 0$, on fait tourner $(C_f)$ autour de l’axe des abscisses, ce qui engendre un solide $S$.  
Calcule en cm$^3$ le volume $V(S)$ de ce solide $S$.
\end{enumerate}
\end{enumerate}
