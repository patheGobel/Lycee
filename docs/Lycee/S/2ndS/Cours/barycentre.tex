...
Le barycentre d'un système de points pondérés ne change pas si l'on multiplie tous les coefficients par un même nombre réel non nul.
...
« En utilisant le résultat de la propriété 2), on en déduit que pour tout point M du plan : »\\
