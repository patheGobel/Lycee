...
\begin{enumerate}
    ...
    \item
    \begin{enumerate}
        \item En déduire que : $\forall x, y \in \mathbb{R}_+^*$,
        $ \frac{x+y}{x^2+y^2} \leq \frac{1}{2} \left( \frac{1}{x} + \frac{1}{y} \right) $

        \item En utilisant des inégalités semblables, démontrer que pour tous réels $x>0$, $y>0$ et $z>0$, on a :
...
\begin{enumerate}
    \item On donne les expressions suivantes : $A = \frac{1}{1+\frac{b}{c}}$, $B = \frac{1}{1+\frac{b}{c+a}}$ et $C = \frac{1}{1+\frac{1}{a+b}}$
    
    Vérifier que $A + B + C = 2$\hfill \textbf{ (1,5 point)}
    \item Mettre sous la forme d'un produit de puissance de nombres premiers :\hfill \textbf{ (1,25 point)}
    $ D = \frac{(-25^3) \times (-16)^3 \times 36^{-3}}{(-8)^4 \times 48^{-2} \times (-15^2)} $
    \item Recopier et compléter le tableau suivant : \textbf{(2,25 pt)}
...
\end{center}
\end{enumerate}
\section*{\underline{Exercice 4 :} (6 points) }

Résoudre dans $\mathbb{R}$
    \begin{enumerate}
        \item $|2x+3| > 0$ \hfill \textbf{ (1 point)}
