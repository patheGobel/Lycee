...
\textbf{Matière: Mathématiques}& \textbf{Niveau : 2nd}\textbf{S} &\textbf{Date: 22/05/2026} & \textbf{Durée : 2 heures} \\ \hline
...
\begin{enumerate}
    \item Rappeler la forme canonique de $P(x)=ax^2+bx+c$ \hfill \textbf{(1 pt)}
    
    \item Soient $P(x)= 2x^2-x+2$ et $Q(x)= 3x^2-2\sqrt{3}x+1$.
    \begin{enumerate}
        \item Donner la forme canonique de $P(x)$ et $Q(x)$ \hfill \textbf{(0,75 pt)}
        \item Factoriser si possible $P(x)$ et $Q(x)$ \hfill \textbf{(1,25 pt)}
    \end{enumerate}
...
\begin{enumerate}
    \item $2|x - 2|^2 + 7|x - 2| + 3 = 0$ \hfill \textbf{(1,5 pt)}
    
    \item $\left(x + \dfrac{1}{x}\right)^2 = 4\left(x + \dfrac{1}{x}\right) - 3$ \hfill \textbf{(1,5 pt)}
...
\begin{enumerate}
    \item $\alpha_1 = \dfrac{2027\pi}{4}$ \hfill \textbf{(1 pts)}
    \item $\alpha_2 = -\dfrac{31\pi}{6}$ \hfill \textbf{(1 pts)}
    \item $\alpha_3 = \dfrac{2026\pi}{7}$ \hfill \textbf{(1 pts)}
    \item $\alpha_4 = -40\pi$ \hfill \textbf{(1 pts)}
\end{enumerate}

\item Calculer les valeurs exactes suivantes : 
\begin{enumerate}
\item $\cos \left( \dfrac{2027\pi}{4} \right)$ \hfill \textbf{(1 pts)}
\item $\sin \left( -\dfrac{31\pi}{6} \right)$ \hfill \textbf{(1 pts)}
\item $\cos \left( -40\pi \right)$ \hfill \textbf{(1 pts)}
\item $\sin \left( 21\pi \right)$ \hfill \textbf{(1 pts)}
\item $\sin \left( \dfrac{2026\pi}{7} \right)$ \hfill \textbf{(1 pts)}
\end{enumerate}

\item Compléter par le signe qui convient \hfill \textbf{(1 pts)}

\begin{tikzpicture}

        \tkzTabInit[lgt=2, espcl=1.5]{$\alpha$ / .8, $\sin \alpha$ / .8, $\cos \alpha$ / .8}{$-\pi$, $-\pi/2$, $0$, $\pi/2$, $\pi$}

        \tkzTabLine{,\cdots , z,\cdots , z,\cdots , z,\cdots , }
