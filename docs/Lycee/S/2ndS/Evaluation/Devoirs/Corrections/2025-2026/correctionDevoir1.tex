...
B &= \frac{\dfrac{1}{a}-\dfrac{1}{b}}{\dfrac{1}{a}+\dfrac{1}{b}}
  ...
  &= \frac{b-a}{a-b}\cdot (a+b) \\[6pt]
  &= -1\cdot (a+b) \\[6pt]
  &= -(a+b).
\end{aligned}
\]

\[ \textcolor{red}{\boxed{B=-(a+b)} } \]
...
\begin{aligned}
A &= 
\dfrac{(0{,}009)^{-3} (0{,}016)^2 \cdot 250}
...
\\[6pt]
&=
2^{5} \cdot 3^{-18} \cdot 5^{1}.
\end{aligned}
\]

\[ \textcolor{red}{\boxed{C=2^{5} \cdot 3^{-18} \cdot 5^{1}} } \]

\[
\begin{aligned}
B &= 
\dfrac{(-6)^4 \cdot 30^{-2} \cdot (-10)^{-3} \cdot 15^4}
