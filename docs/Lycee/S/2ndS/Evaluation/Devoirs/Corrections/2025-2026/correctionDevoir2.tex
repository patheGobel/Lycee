...
\begin{enumerate}
%---------------------------------
\item \textbf{Encadrement de $x-y$}

On a $-2 \le x \le -1$ et $2 \le y \le 3$.

\begin{itemize}
\item $x$ est maximal pour $x=-1$ et $y$ est minimal pour $y=2$ :
\[
x-y \le -1-2=-3
\]
\item $x$ est minimal pour $x=-2$ et $y$ est maximal pour $y=3$ :
\[
x-y \ge -2-3=-5
\]
\end{itemize}
...
\textbf{Amplitude de l’encadrement :}
\[
-3-(-5)=2
\]

%---------------------------------
\item \textbf{Encadrement de $xy$}

\begin{enumerate}
\item $-10 \le x \le -7$ et $1 \le y \le 2$

$x$ est négatif et $y$ positif, donc $xy$ est négatif.

\[
\begin{aligned}
x=-10,\;y=2 &\Rightarrow xy=-20 \\
x=-7,\;y=1 &\Rightarrow xy=-7
\end{aligned}
\]
...
\item $-2 \le x \le 5$ et $2 \le y \le 7$

$x$ peut être négatif ou positif, $y$ est positif.

\[
\begin{aligned}
x=-2,\;y=7 &\Rightarrow xy=-14 \\
x=5,\;y=7 &\Rightarrow xy=35
\end{aligned}
\]

Donc
\[
\boxed{-14 \le xy \le 35}
\]
\end{enumerate}

%---------------------------------
\item \textbf{Encadrement de $x^2$}
...
%---------------------------------
\item \textbf{Encadrement de $\dfrac{x}{y}$}

\begin{enumerate}
\item $1 \le x \le 2$ et $3 \le y \le 7$

$x$ et $y$ sont positifs.

\[
\frac{1}{7} \le \frac{x}{y} \le \frac{2}{3}
\]

\item $-3 \le x \le -1$ et $-7 \le y \le 2$

\textbf{Attention :} $y$ peut s’annuler.

\[
\boxed{\text{Encadrement impossible car } y=0 \text{ est possible}}
\]

\item $-5 \le x \le -3$ et $-1 \le y \le 3$
...
\begin{enumerate}
        \item $|2x+3| > 0 $ toujours vrai deonc $ S=\mathbb{R}\setminus\{ -\dfrac{3}{2}\} $ \hfill \textbf{ (1 point)}

 \begin{resultbox}
    \[
    \mathbf{ S=\mathbb{R} }\setminus\{ -\dfrac{3}{2} \}
    \]
\end{resultbox}        
