...
\begin{enumerate}
\item Rappeler la forme canonique de \( P(x)=ax^2+bx+c \) \textbf{( 0,5 pt)}
\begin{enumerate}
Soit \( P(x)= 2x^2-x+2 \) et \( Q(x)= 3x^2-2\sqrt{3}\,x+1 \)
\item Donner la forme canonique  de \( P(x) \) et \( Q(x) \) \textbf{( 0,75 pt)}
\item Factoriser si possible \( P(x) \) et \( Q(x) \) \textbf{( 0,75 pt)}
\end{enumerate}

\item Résoudre dans $\mathbb{R}$ les équations et les inéquations suivantes :
\begin{enumerate}
    \item $x^2 + 2x - 15 = 0$ \textbf{( 1 pt)}
    \item $2x^2 - 9x + 4 \geq 0$ \textbf{( 1 pt)}
    \item $6x^4 - x^2 - 5 \leq 0$ \textbf{( 1 pt)}
\end{enumerate}
\end{enumerate}

\section*{\underline{Exercice 2 :} ( 5 points) }

Résoudre dans $\mathbb{R}$ ou $\mathbb{R}^{2}$ les équations et les inéquations suivantes :

\begin{enumerate}
    \item $2|x - 2|^2 + 7|x - 2| + 3 = 0$ \textbf{( 1 pt)}
    \item $\frac{2x^2 + 3x - 5}{-x^2 + 3x + 10} \leq 0$ \textbf{( 1 pt)}
    \item $\left(x + \frac{1}{x}\right)^2 = 4\left(x + \frac{1}{x}\right) - 3$ \textbf{( 1 pt)}
    \item     \(
    \begin{cases}
    x + y = 3 \\
    x^2 + 3xy + y^2 = 11
    \end{cases}
    \) \textbf{( 1 pt)}
    \item la méthode de \textbf{Cramer} \(
\begin{cases}
3x + 4y = 5 \\
2x - 3y = 1
\end{cases}
...
Déterminer la mesure principale $\alpha \in ]-\pi ; \pi]$ des angles orientés suivants :

\begin{enumerate}
    \item $\theta_1 = \dfrac{2027\pi}{4}$ \textbf{(0,5 pt)}
    \item $\theta_2 = -\dfrac{31\pi}{6}$ \textbf{(0,5 pt)}
    \item $\theta_3 = \dfrac{2026\pi}{7}$ \textbf{(0,5 pt)}
    \item $\theta_6 = 40\pi$ \textbf{(0,5 pt)}
\end{enumerate}
Calculer $\cos \left( \dfrac{97\pi}{4} \right)$ et $\sin \left( \dfrac{31\pi}{4} \right)$ \textbf{(1 pt)}
\end{document}
