...
$ 3{,}142 < \dfrac{22}{7} < 3{,}144 .$\hfill \textbf{Faux}\\($ 3{,}142 < \dfrac{22}{7} < 3{,}143 .$)
\end{enumerate}
...
\section*{\underline{Correction de l'Exercice 4 :} 3,5 points (Calcul de Fractions et Priorité des Opérations)}
...
\begin{enumerate}
    ...
    C &= \frac{8 - 9}{4} + \left(\frac{9}{4}\right) \\
    C &= \frac{8 - 9 + 9}{4} \\
    C &= -\frac{8}{4} \\
    C &= -2 \\
    \end{aligned}
