...
\begin{enumerate}
    \item Les trois \textbf{bissectrices} d'un triangle se coupent au centre du cercle inscrit. \hfill \textbf{(1,5 pt)}
    \item Le point de rencontre des trois \textbf{hauteurs} est appelé \textbf{orthocentre}. \hfill \textbf{(1,5 pt)}
    \item Le \textbf{centre de gravité} est le point d'intersection des trois médianes. \hfill \textbf{(1,5 pt)}
    \item Les trois \textbf{médiatrices} d'un triangle se coupent au centre du cercle circonscrit. \hfill \textbf{(1,5 pt)}
\end{enumerate}
...
\begin{aligned}
(2x - 4)(3x + 9) &= 0\\
2x - 4 = 0 &\textbf{ ou } 3x + 9 = 0\\
2x = 4 &\textbf{ ou } 3x = -9\\
x = \frac{4}{2} &\textbf{ ou } x = \frac{-9}{3}\\
x = 2 &\textbf{ ou } x = -3\\
\end{aligned}
\)
\end{enumerate}
