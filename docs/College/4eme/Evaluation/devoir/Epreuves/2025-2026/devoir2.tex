...
\begin{enumerate}
\item Les fractions $\dfrac{7}{5}$ et $\dfrac{70}{50}$ sont égales. \hfill \textbf{Vrai}
\item L'inverse de $-\dfrac{5}{7}$ est $\dfrac{7}{5}$. \hfill \textbf{Faux}
\item Si $a \leq b$ alors $a +c \leq b+c$. \hfill \textbf{Vrai}
\item $ \left(\dfrac{a}{b} \right)^{n} \times \left(\dfrac{a}{b} \right)^{m} = \left(\dfrac{b}{a} \right)^{m+n} $. \hfill \textbf{Faux}
\item $\dfrac{7}{5} < \dfrac{4}{5}$ et $\dfrac{1}{5} < \dfrac{4}{3}$. \hfill \textbf{Faux}
\end{enumerate}
...
\begin{enumerate}
    ...
    \item Les cercles $(\mathscr{C})$ et $(\mathscr{C'})$ sont \textbf{disjoints extérieurement} si et seulement si $OO' > r + r'$.
    \item Les cercles $(\mathscr{C})$ et $(\mathscr{C'})$ sont \textbf{sécants} si et seulement si $|r - r'| < OO' < r + r'$.
    \item Si $OO' > r + r'$, alors $(\mathscr{C})$ et $(\mathscr{C'})$ sont \textbf{disjoints extérieurement}.
    \item Si $OO' = |r - r'|$, alors $(\mathscr{C})$ et $(\mathscr{C'})$ sont \textbf{tangents intérieurement}.
\end{enumerate}
...
\hline
\textbf{$O_1O_2$} & 12 & 15,7 & 15,6 & 13 & 24 \\
\hline
\textbf{$R_1 + R_2$} & & & & & \\
\hline
\textbf{$|R_1 - R_2|$} & & & & & \\
...
\section*{\underline{Exercice 3 :} 3 points (Calcul de Fractions et Priorité des Opérations)}
