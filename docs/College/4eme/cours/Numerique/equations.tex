...
Résoudre dans $\mathbb{Q}$ les équations ci-dessous :
\begin{enumerate}
    \item $(3x - 6)(x + 4) = 0$
    \item $(2x + 5)(5x - 10) = 0$
    \item $(4x - 8)(2x + 3) = 0$
    ...
    \item $(5x + 1)(5x + 1) = 0$
\end{enumerate}
\subsection*{\textcolor{red}{3) Passage de la factorisation à la forme $(ax+b)(cx+d)=0$}}

Pour résoudre certaines équations, on peut mettre l’expression sous forme factorisée afin d’obtenir un produit de deux expressions.
