...
\begin{center}
    \Large\textbf{\underline{DROITES REMARQUABLES DANS UN TRIANGLE}}\\[-0.1cm]
...
\paragraph{\textcolor{red}{4) \underline{Propriétés} :}}
\begin{itemize}
...
\paragraph{\textcolor{red}{5) \underline{Cercle inscrit dans un triangle} :}}
