...
\begin{enumerate}
    \item Donner une formule d’Al-Kashi appliquée à ce triangle.\textbf{ 0,5 pt}\\[0.2cm]
    \underline{\hspace{20cm}}\\[0.2cm]
    \item Donner la loi des sinus.\textbf{ 0,5 pt}\\[0.2cm]
    \underline{\hspace{20cm}}\\[0.5cm]
    \item Donner l'équation du cercle de centre I $\begin{pmatrix} a \\ b \end{pmatrix}$ et de rayon r .\textbf{ 0,5 pt}\\[0.2cm]
    \underline{\hspace{20cm}}\\[0.5cm]
