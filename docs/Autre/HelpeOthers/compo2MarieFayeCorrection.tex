...
\begin{enumerate}
    ...
    L'expression donnée est exacte, l'affirmation est donc \textbf{Vraie}.
\end{enumerate}
...
\begin{tikzpicture}
   ...
   % Note : Utilisation de -D+/ en colonne 5 pour honorer proprement le 'd' de la dérivée
   \tkzTabVar{-/ $1$, +D-/ $+\infty$ / $-\infty$, R/, +/ $\dfrac{1}{2}$, -/ $0$ / $0$, +/ $+\infty$}
   
   % 4. L'astuce d'Hercule Poirot : On cherche de la colonne 2 à la colonne 4 !
   \tkzTabIma{2}{4}{3}{$0$}
\end{tikzpicture}
\end{center}   
