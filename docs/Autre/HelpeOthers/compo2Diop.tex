...
%\vspace{3cm}
\begin{center}
    \Large\textbf{Composition du Second Semestre} \\
    \large\textbf{Épreuve de Mathématiques}
\end{center}
...
\begin{enumerate}
    ...
    \item Déterminer l'ensemble (E) des points M du plan tel que :\hfill \textbf{(2pt)}
    \begin{multicols}{2}
