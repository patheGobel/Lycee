...
% Création du compteur pour la corrections des exercices
\newcounter{correction}
\renewcommand{\thecorrection}{\arabic{correction}}  % Définit l'affichage du compteur en chiffres arabes

% Définir la commande \exo
\newcommand{\correc}{\refstepcounter{correction}\textbf{Correction \thecorrection} }
