...
\begin{enumerate}
    ...
    La transformation \( S_{p} \circ S_{p_{1}} \) est la rotation d’axe  $P \cap P_{1} = \Delta_{1}$ et d’angle 2 l’angle formé par

C’est donc le demi-tour d’axe  c’est à dire 
\end{enumerate}
\end{enumerate}
