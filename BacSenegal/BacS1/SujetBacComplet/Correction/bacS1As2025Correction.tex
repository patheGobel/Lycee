...
\]
    ...
    \begin{center}
    \fbox{\( p_n = \dfrac{2n}{2^{n-1}} \)} \hfill \textbf{(0,75 point)}
    \end{center}
\item Étudions la variation de la suite \( (p_n)_{n \geq 3} \). \hfill \textbf{(0,5 point)}
		...
		\(
		\begin{aligned}
		p_{n+1} - p_n &= \dfrac{2(n+1)}{2^{n}} - \dfrac{2n}{2^{n-1}}\\
									&= \dfrac{2n+2}{2^{n}} - \dfrac{2n}{2^{n-1}}\\
									&= \dfrac{n+1}{2^{n-1}} - \dfrac{2n}{2^{n-1}}\\
									&= \dfrac{-n+1}{2^{n-1}}\\
		\end{aligned}
		\)

Donc $p_{n+1} - p_n = \dfrac{-n+1}{2^{n-1}}$

Comme $n \geq 3$ alors $-n+1 < 0$ donc $\dfrac{-n+1}{2^{n-1} } < 0$ d'où $\forall n \geq 3$, $p_n <0$
