...
\section*{\underline{Correction Exercice 1 :} 5 pts }
...
\end{center}
    ...
    \item Construisons \( (C_f) \). \hfill \textbf{0{,}1 pt}

\begin{center}
\begin{figure}[H]% Forcer l'image à cet endroit
\centering
\includegraphics[width=0.8\textwidth]{courbeProblemCompo1erS2.png}
\caption{Représentation graphique de la courbe}
\label{fig:monimage}
\end{figure}
\href{https://www.geogebra.org/classic/vnbufdbb}{Clique ici pour voir la courbe sur géogébra}\\
\end{center}    
